...
def test_vision_error_handled_gracefully(mock_analyze):
    """If analyze_medical_image returns unknown/0.0 confidence, node returns safe fallback findings."""
    # V5 design: analyze_medical_image catches exceptions internally and returns
    # {"image_type": "unknown", "confidence": 0.0, "explanation": "error msg"}
    mock_analyze.return_value = {"image_type": "unknown", "confidence": 0.0, "explanation": "Model unavailable"}
